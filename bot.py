...
Полный перенос веб-квиза (12 вопросов, 12 архетипов бренда по модели Кэрол Пирсон) в Telegram-бота.
...
DISCLAIMER = (
    ...
    "или гарантией. Типология архетипов основана на "
    "модели 12 архетипов бренда Кэрол Пирсон (Carol S. Pearson), которая "
    "опирается на теорию архетипов К. Г. Юнга."
)
...
# ---------------------------------------------------------------------------
# 12 архетипов бренда по модели Кэрол Пирсон
# ---------------------------------------------------------------------------
...
async def cmd_start(message: Message) -> None:
    ...
    intro = (
        ...
        "модели Кэрол Пирсон (от Правителя до Простодушного), палитру, шрифты и "
